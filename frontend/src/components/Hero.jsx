...
export default function Hero() {
  ...
  return <section className="hero" id="home"><div className="hero-copy">
    ...
    <form className="hero-search" onSubmit={submit}><Search size={19}/><input aria-label="Tìm công thức, bài viết và video" value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Tìm công thức, bài viết, video..."/><button type="submit" aria-label="Tìm kiếm"><ArrowRight size={20}/></button></form>
