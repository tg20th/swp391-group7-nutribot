...
export default function LoginPage() {
  ...
  return <main className="register-page login-page">
    ...
    <section className="register-card-wrap"><form className="register-card" noValidate onSubmit={submit}>
      ...
      {serverError && <p className="form-alert form-alert-error" role="alert">{serverError}</p>}{success && <p className="form-alert form-alert-success" role="status"><CheckCircle2 size={18}/>{success}</p>}
